  ...
  return (
    <nav className="w-full bg-[#15132b] text-white flex justify-between items-center gap-10 px-2 py-4 font-cairo shadow-inner">
      <div className="bg-[#15132b] flex flex-row gap-10 justify-between w-full ">
        {/* Search Bar */}
        <div className="hidden lg:flex items-center justify-start mt-2 rounded-3xl w-80 h-10 bg-[#211A75] ">
          <img
            className="p-2 rounded-3xl w-10 h-10"
            src="search_icon.svg"
          ></img>
          <input
            type="text"
        ...
        {/* Language Selector */}
        <div className="hidden lg:flex items-center space-x-2 bg-[#211A75] rounded-3xl px-2">
