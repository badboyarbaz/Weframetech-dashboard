...
function ConditionalSidebar() {
  ...
  <div className="relative flex flex-row space-x-4 justify-center items-center gap-2">
   ...
   <div className="flex absolute top-0 ml-5 p-1 w-4 h-4  bg-[#5DCFFF] rounded-full text-[10px] justify-center items-center">12</div>
    </div> {/* Activity */}
    <div>
   <img className="w-8 h-8" src="frame_icon.svg"></img>
   <div className="flex absolute top-0 ml-5 p-1 w-4 h-4  bg-[#5DCFFF] rounded-full text-[10px] justify-center items-center"> 5</div>
    </div>  {/* Notification */}
    <div>
   <img className="w-8 h-8" src="check_icon.svg"></img>
   <div className="flex absolute top-0 ml-5 p-1  w-4 h-4 bg-[#5DCFFF] rounded-full text-[10px] justify-center items-center"> 2</div>
    </div> {/* Check */}
    <div>
     ...
     <div className="flex flex-col items-center w-full bg-[#15132B] justify-center">
      ...
      <div className="flex flex-col items-center bg-[#15132B] justify-center  ">
        ...
        <div className="relative w-52 h-40 rounded-3xl overflow-hidden">
          ...
          <div className="absolute z-20 top-16 left-5 text-white font-medium">Increase your <br/>work with kanban</div>
